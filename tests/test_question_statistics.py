...
# Disabled because input files are outdated
# class TestQuestionScraper:
#     def test_correct(self):
#         q = Quora()
#         stats1 = q.scrape_question_stats(BeautifulSoup(open('tests/input_files/question_1'), "html.parser"))
#         stats2 = q.scrape_question_stats(BeautifulSoup(open('tests/input_files/question_2'), "html.parser"))
